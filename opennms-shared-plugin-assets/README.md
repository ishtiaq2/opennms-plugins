...
**plugins one by one**, each installed by dropping its KAR into a second host folder.
...
and Felix FileInstall 3.7.4 was read for every claim ([source trace](docs/reference/source-trace.md)).
