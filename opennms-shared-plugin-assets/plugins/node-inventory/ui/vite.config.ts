...
const EXTENSION_ID = 'labNodeInventory' // src/main.ts assigns window[EXTENSION_ID]
const RESOURCE_ROOT = 'node-inventory' // folder inside the bundle JAR, one path segment
const MODULE_FILE = 'nodeInventory.es.js' // must contain ".es"
