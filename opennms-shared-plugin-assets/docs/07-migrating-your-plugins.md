# Part 7 - Moving your existing plugins to the shared folder
...
## 7.2 Add the helper to each plugin
...
## 7.4 Check the plugin contract

`scripts/check_plugins.py` accepts your bundle modules as arguments:
...
Part 3 against the built module. It also warns when a module still contains large inlined images
