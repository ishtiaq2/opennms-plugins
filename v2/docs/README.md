...
| [Architecture: OpenNMS step by step](architecture/README.md) | How is OpenNMS built inside: one JVM, the daemons, Jetty, Karaf, Felix, bundles and plugins, and how a plugin UI and the shared files reach the browser? (16 steps, a diagram each) |
...
To understand OpenNMS itself (what runs in the process, how Karaf, Felix and Jetty fit together,
and how a plugin is loaded and served), read the [architecture guide](architecture/README.md),
which uses this lab as its running example.
