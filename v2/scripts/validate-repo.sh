...
run python3 -m py_compile scripts/assets.py scripts/check_plugins.py scripts/kar_info.py scripts/check_links.py \
  tests/scripts/test_tools.py docs/architecture/images/make_diagrams.py docs/architecture/images/svglib.py
...
step "architecture diagrams match their generator (docs/architecture/images)"
run python3 docs/architecture/images/make_diagrams.py --check

step "Markdown links point at existing files and headings"
